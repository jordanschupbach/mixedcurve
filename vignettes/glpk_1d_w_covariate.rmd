...
```{r, fig.filename="m2_data.png", fig.width=6, fig.height=6,  message=FALSE, warning=FALSE}
...
```{r, fig.filename="m2_fit.png", fig.width=6, fig.height=6,  message=FALSE, warning=FALSE}
...
wy_pvals <- mixedcurve::wy_full(
  ...
  gen_pvals_fun = function(data, xseq) {
    lpk_res <- mixedcurve::lpk(
      y ~ K_h(x1 | cov), queries = xseq, data = data, degree = 0,
      kernel = mixedcurve::gauss_kern,
