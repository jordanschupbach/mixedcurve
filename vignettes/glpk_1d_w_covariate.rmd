...
```{r, fig.filename="m3_data.png", fig.width=6, fig.height=6, out.width= "78%", message=FALSE, warning=FALSE}
...
bandwidth, kernel type, degree, and use the formula `y ~ K_h(x1 | cov)` to
indicate that we want to fit separate curves for each level of the covariate `cov`.
