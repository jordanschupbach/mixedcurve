...
# 3. Plot the data
png("gnw_1d_poisson_data.png", width = 2 * 800, height = 800, res = 100)
...
legend("topright",
  ...
  col = c(adjustcolor("red", 0.90),
          adjustcolor("yellow", 0.90)
  ),
  pch = c(20, 20)
)
invisible(dev.off())
...
# 5. Plot the results
png("gnw_1d_poisson_fit.png", width = 2 * 800, height = 800, res = 100)
mixedcurve::dark_mode()
plot(df1$x, df1$y,
  col = adjustcolor("yellow", 0.2),
  pch = 20, ylim = c(0, 30),
