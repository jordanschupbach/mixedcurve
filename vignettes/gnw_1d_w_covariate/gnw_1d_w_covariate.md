...
df1 <- fundata1$df
# 3. Plot the data
# png("./vignettes/gnw_1d_w_covariate/gnw_1d_poisson_data.png", width = 4800, height = 4800, res = 600)
...
# 5. Plot the results
# png("./vignettes/gnw_1d_w_covariate/gnw_1d_poisson_fit.png", width = 4800, height = 4800, res = 600)
